...
// author objects
        ...
        $author_avatar = $fields['picture']->content;
        $author_signature = $fields['signature']->content;

        preg_match_all('/<img[^>]+>/i',$image, $imageResult);        
        $no_image = '<img src="/sites/all/themes/zen_spaceblues/images/portrait.png">';
//check first two images for now, this suckssssssssssssss
...
<div class="browse-portfolios">
	<div class="browse-portfolios-author-details" style="visibility:hidden;">
		<div class="browse-portfolios-author-details-inner">
			<div class="browse-portfolios-author-details-left">
				<div class="author-avatar"><?php print $author_avatar; ?></div>
			</div>
			<div class="browse-portfolios-author-details-right">
				<div class="author-name"><?php print $author_name; ?></div>
				<div class="author-signature"><?php print render($author_signature); ?></div>
			</div>
		</div>
	</div>
	...
	<div class="browse-portfolios-details">
		...
		<div><div class="browse-portfolios-item tags">Tags: <?php print $tags; ?></div></div>		
		<div><div class="browse-portfolios-item description"><?php print $description; ?></div></div>
	</div>
